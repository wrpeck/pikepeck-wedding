...
export default function HeroLayout1(props) {
  ...
  const variants = [
    ...
    {
      overrides: {
        SmallTitle: { color: "rgba(255,255,255,1)" },
        BigTitle: { color: "rgba(255,255,255,1)" },
        HeroBody: { color: "rgba(255,255,255,1)" },
        Message: {},
        Button: {},
        HeroMessage: {},
      ...
      >
        ...
        >
          <Text
            ...
            {...getOverrideProps(overrides, "SmallTitle")}
          ></Text>
          <Flex
            gap="16px"
            direction="column"
          ...
          >
            <Text
              ...
              {...getOverrideProps(overrides, "BigTitle")}
            ></Text>
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              {...getOverrideProps(overrides, "HeroBody")}
            ></Text>
          </Flex>
          <Button
            display="flex"
