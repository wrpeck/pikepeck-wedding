...
export default createTheme({
  ...
  tokens: {
    ...
    colors: {
      ...
      brand: {
        primary: {
          10: { value: "hsl(7, 42%, 75%)" },
          20: { value: "hsl(7, 42%, 70%)" },
          40: { value: "hsl(7, 42%, 60%)" },
          60: { value: "hsl(7, 42%, 50%)" },
          80: { value: "hsl(7, 42%, 40%)" },
          90: { value: "hsl(7, 42%, 30%)" },
          100: { value: "hsl(7, 42%, 25%)" },
        },
        secondary: {
          10: { value: "hsl(120, 21%, 84%)" },
          20: { value: "hsl(120, 22%, 81%)" },
          40: { value: "hsl(122, 22%, 75%)" },
          60: { value: "hsl(122, 21%, 68%)" },
          80: { value: "hsl(122, 12%, 55%)" },
          90: { value: "hsl(120, 10%, 41%)" },
          100: { value: "hsl(123, 10%, 34%)" },
        },
      },
      font: {
        ...
        info: { value: "hsl(213, 38%, 37%)" },
        warning: { value: "{colors.orange.90.value}" },
        error: { value: "hsl(352, 79%, 24%)" },
        success: { value: "hsl(71, 29%, 77%)" },
      },
      background: {
        primary: { value: "{colors.white.value}" },
        secondary: { value: "hsl(24, 69%, 92%)" },
